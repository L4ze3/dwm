...
static const char *raisevol[] = { "pulseaudio-ctl", "up", "5%", NULL };
static const char *lowervol[] = { "pulseaudio-ctl", "down", "5%", NULL };
static const char *mute[]  = { "pulseaudio-ctl", "mute", "5%", NULL };
